...
import mod.silverwolfs.litesilverwolfsbuildingblocks.object.blocks.*;
import mod.silverwolfs.litesilverwolfsbuildingblocks.util.WoodenPlank;
...
public class BlockInit {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, LiteSilverwolfsBuildingBlocks.MOD_ID);
    ...
    private static Supplier<BlockItem> itemDefault(final RegistryObject<? extends Block> block) {
        return item(block, LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance);
    }
    ...
    //block items
    public static final RegistryObject<BlockItem> THATCH_BLOCK_ITEM = ItemInit.ITEMS.register("thatch_block", () -> new BlockItem(THATCH_BLOCK.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_BUTTON_ITEM = ItemInit.ITEMS.register("thatch_button", () -> new BlockItem(THATCH_BUTTON.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_FENCE_ITEM = ItemInit.ITEMS.register("thatch_fence", () -> new BlockItem(THATCH_FENCE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_FENCE_GATE_ITEM = ItemInit.ITEMS.register("thatch_fence_gate", () -> new BlockItem(THATCH_FENCE_GATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_DOOR_ITEM = ItemInit.ITEMS.register("thatch_door", () -> new BlockItem(THATCH_DOOR.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_LADDER_ITEM = ItemInit.ITEMS.register("thatch_ladder", () -> new BlockItem(THATCH_LADDER.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_PRESSURE_PLATE_ITEM = ItemInit.ITEMS.register("thatch_pressure_plate", () -> new BlockItem(THATCH_PRESSURE_PLATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_SLAB_ITEM = ItemInit.ITEMS.register("thatch_slab", () -> new BlockItem(THATCH_SLAB.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_STAIRS_ITEM = ItemInit.ITEMS.register("thatch_stairs", () -> new BlockItem(THATCH_STAIRS.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> THATCH_TRAPDOOR_ITEM = ItemInit.ITEMS.register("thatch_trapdoor", () -> new BlockItem(THATCH_TRAPDOOR.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));

    public static final RegistryObject<BlockItem> BAMBOO_BLOCK_ITEM = ItemInit.ITEMS.register("bamboo_block", () -> new BlockItem(BAMBOO_BLOCK.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_BUTTON_ITEM = ItemInit.ITEMS.register("bamboo_button", () -> new BlockItem(BAMBOO_BUTTON.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_FENCE_ITEM = ItemInit.ITEMS.register("bamboo_fence", () -> new BlockItem(BAMBOO_FENCE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_FENCE_GATE_ITEM = ItemInit.ITEMS.register("bamboo_fence_gate", () -> new BlockItem(BAMBOO_FENCE_GATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_DOOR_ITEM = ItemInit.ITEMS.register("bamboo_door", () -> new BlockItem(BAMBOO_DOOR.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_LADDER_ITEM = ItemInit.ITEMS.register("bamboo_ladder", () -> new BlockItem(BAMBOO_LADDER.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_PRESSURE_PLATE_ITEM = ItemInit.ITEMS.register("bamboo_pressure_plate", () -> new BlockItem(BAMBOO_PRESSURE_PLATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_SLAB_ITEM = ItemInit.ITEMS.register("bamboo_slab", () -> new BlockItem(BAMBOO_SLAB.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_STAIRS_ITEM = ItemInit.ITEMS.register("bamboo_stairs", () -> new BlockItem(BAMBOO_STAIRS.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BAMBOO_TRAPDOOR_ITEM = ItemInit.ITEMS.register("bamboo_trapdoor", () -> new BlockItem(BAMBOO_TRAPDOOR.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));

    public static final RegistryObject<BlockItem> ACACIA_BEAM_UP_ITEM = ItemInit.ITEMS.register("acacia_beam_up", () -> new BlockItem(ACACIA_BEAM_UP.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> ACACIA_BEAM_MIDDLE_ITEM = ItemInit.ITEMS.register("acacia_beam_middle", () -> new BlockItem(ACACIA_BEAM_MIDDLE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> ACACIA_BEAM_DOWN_ITEM = ItemInit.ITEMS.register("acacia_beam_down", () -> new BlockItem(ACACIA_BEAM_DOWN.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BIRCH_BEAM_UP_ITEM = ItemInit.ITEMS.register("birch_beam_up", () -> new BlockItem(BIRCH_BEAM_UP.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BIRCH_BEAM_MIDDLE_ITEM = ItemInit.ITEMS.register("birch_beam_middle", () -> new BlockItem(BIRCH_BEAM_MIDDLE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BIRCH_BEAM_DOWN_ITEM = ItemInit.ITEMS.register("birch_beam_down", () -> new BlockItem(BIRCH_BEAM_DOWN.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> DARK_OAK_BEAM_UP_ITEM = ItemInit.ITEMS.register("dark_oak_beam_up", () -> new BlockItem(DARK_OAK_BEAM_UP.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> DARK_OAK_BEAM_MIDDLE_ITEM = ItemInit.ITEMS.register("dark_oak_beam_middle", () -> new BlockItem(DARK_OAK_BEAM_MIDDLE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> DARK_OAK_BEAM_DOWN_ITEM = ItemInit.ITEMS.register("dark_oak_beam_down", () -> new BlockItem(DARK_OAK_BEAM_DOWN.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> JUNGLE_BEAM_UP_ITEM = ItemInit.ITEMS.register("jungle_beam_up", () -> new BlockItem(JUNGLE_BEAM_UP.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> JUNGLE_BEAM_MIDDLE_ITEM = ItemInit.ITEMS.register("jungle_beam_middle", () -> new BlockItem(JUNGLE_BEAM_MIDDLE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> JUNGLE_BEAM_DOWN_ITEM = ItemInit.ITEMS.register("jungle_beam_down", () -> new BlockItem(JUNGLE_BEAM_DOWN.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> OAK_BEAM_UP_ITEM = ItemInit.ITEMS.register("oak_beam_up", () -> new BlockItem(OAK_BEAM_UP.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> OAK_BEAM_MIDDLE_ITEM = ItemInit.ITEMS.register("oak_beam_middle", () -> new BlockItem(OAK_BEAM_MIDDLE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> OAK_BEAM_DOWN_ITEM = ItemInit.ITEMS.register("oak_beam_down", () -> new BlockItem(OAK_BEAM_DOWN.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> SPRUCE_BEAM_UP_ITEM = ItemInit.ITEMS.register("spruce_beam_up", () -> new BlockItem(SPRUCE_BEAM_UP.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> SPRUCE_BEAM_MIDDLE_ITEM = ItemInit.ITEMS.register("spruce_beam_middle", () -> new BlockItem(SPRUCE_BEAM_MIDDLE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> SPRUCE_BEAM_DOWN_ITEM = ItemInit.ITEMS.register("spruce_beam_down", () -> new BlockItem(SPRUCE_BEAM_DOWN.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));

    public static final RegistryObject<BlockItem> ACACIA_LADDER_ITEM = ItemInit.ITEMS.register("acacia_ladder", () -> new BlockItem(ACACIA_LADDER.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> BIRCH_LADDER_ITEM = ItemInit.ITEMS.register("birch_ladder", () -> new BlockItem(BIRCH_LADDER.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> DARK_OAK_LADDER_ITEM = ItemInit.ITEMS.register("dark_oak_ladder", () -> new BlockItem(DARK_OAK_LADDER.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> JUNGLE_LADDER_ITEM = ItemInit.ITEMS.register("jungle_ladder", () -> new BlockItem(JUNGLE_LADDER.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> SPRUCE_LADDER_ITEM = ItemInit.ITEMS.register("spruce_ladder", () -> new BlockItem(SPRUCE_LADDER.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));

    public static final RegistryObject<BlockItem> MOSSY_STONE_BLOCK_ITEM = ItemInit.ITEMS.register("mossy_stone", () -> new BlockItem(MOSSY_STONE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_STONE_BUTTON_ITEM = ItemInit.ITEMS.register("mossy_stone_button", () -> new BlockItem(MOSSY_STONE_BUTTON.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_STONE_WALL_ITEM = ItemInit.ITEMS.register("mossy_stone_wall", () -> new BlockItem(MOSSY_STONE_WALL.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_STONE_PRESSURE_PLATE_ITEM = ItemInit.ITEMS.register("mossy_stone_pressure_plate", () -> new BlockItem(MOSSY_STONE_PRESSURE_PLATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_STONE_SLAB_ITEM = ItemInit.ITEMS.register("mossy_stone_slab", () -> new BlockItem(MOSSY_STONE_SLAB.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_STONE_STAIRS_ITEM = ItemInit.ITEMS.register("mossy_stone_stairs", () -> new BlockItem(MOSSY_STONE_STAIRS.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));

    public static final RegistryObject<BlockItem> MORE_MOSSY_STONE_BLOCK_ITEM = ItemInit.ITEMS.register("more_mossy_stone", () -> new BlockItem(MORE_MOSSY_STONE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_STONE_BUTTON_ITEM = ItemInit.ITEMS.register("more_mossy_stone_button", () -> new BlockItem(MORE_MOSSY_STONE_BUTTON.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_STONE_WALL_ITEM = ItemInit.ITEMS.register("more_mossy_stone_wall", () -> new BlockItem(MORE_MOSSY_STONE_WALL.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_STONE_PRESSURE_PLATE_ITEM = ItemInit.ITEMS.register("more_mossy_stone_pressure_plate", () -> new BlockItem(MORE_MOSSY_STONE_PRESSURE_PLATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_STONE_SLAB_ITEM = ItemInit.ITEMS.register("more_mossy_stone_slab", () -> new BlockItem(MORE_MOSSY_STONE_SLAB.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_STONE_STAIRS_ITEM = ItemInit.ITEMS.register("more_mossy_stone_stairs", () -> new BlockItem(MORE_MOSSY_STONE_STAIRS.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));

    public static final RegistryObject<BlockItem> MOSSY_ANDESITE_BLOCK_ITEM = ItemInit.ITEMS.register("mossy_andesite", () -> new BlockItem(MOSSY_ANDESITE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_ANDESITE_BUTTON_ITEM = ItemInit.ITEMS.register("mossy_andesite_button", () -> new BlockItem(MOSSY_ANDESITE_BUTTON.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_ANDESITE_WALL_ITEM = ItemInit.ITEMS.register("mossy_andesite_wall", () -> new BlockItem(MOSSY_ANDESITE_WALL.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_ANDESITE_PRESSURE_PLATE_ITEM = ItemInit.ITEMS.register("mossy_andesite_pressure_plate", () -> new BlockItem(MOSSY_ANDESITE_PRESSURE_PLATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_ANDESITE_SLAB_ITEM = ItemInit.ITEMS.register("mossy_andesite_slab", () -> new BlockItem(MOSSY_ANDESITE_SLAB.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MOSSY_ANDESITE_STAIRS_ITEM = ItemInit.ITEMS.register("mossy_andesite_stairs", () -> new BlockItem(MOSSY_ANDESITE_STAIRS.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));

    public static final RegistryObject<BlockItem> MORE_MOSSY_ANDESITE_BLOCK_ITEM = ItemInit.ITEMS.register("more_mossy_andesite", () -> new BlockItem(MORE_MOSSY_ANDESITE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_ANDESITE_BUTTON_ITEM = ItemInit.ITEMS.register("more_mossy_andesite_button", () -> new BlockItem(MORE_MOSSY_ANDESITE_BUTTON.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_ANDESITE_WALL_ITEM = ItemInit.ITEMS.register("more_mossy_andesite_wall", () -> new BlockItem(MORE_MOSSY_ANDESITE_WALL.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_ANDESITE_PRESSURE_PLATE_ITEM = ItemInit.ITEMS.register("more_mossy_andesite_pressure_plate", () -> new BlockItem(MORE_MOSSY_ANDESITE_PRESSURE_PLATE.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_ANDESITE_SLAB_ITEM = ItemInit.ITEMS.register("more_mossy_andesite_slab", () -> new BlockItem(MORE_MOSSY_ANDESITE_SLAB.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
    public static final RegistryObject<BlockItem> MORE_MOSSY_ANDESITE_STAIRS_ITEM = ItemInit.ITEMS.register("more_mossy_andesite_stairs", () -> new BlockItem(MORE_MOSSY_ANDESITE_STAIRS.get(), new Item.Properties().group(LiteSilverwolfsBuildingBlocks.LiteSilverwolfsBuildingItemGroup.instance)));
